...
import com.gnjb.fitly.model.Constant;
...
public final class Util {
	...
	public static double computeSpeed(double distance, double duration) {
		return ((distance / ((duration * 1000) / Constant.FRAME_DURATION)) / Constant.AVERAGE_INPUT)
				* Constant.AVERAGE_BIKING_SPEED;
	}
