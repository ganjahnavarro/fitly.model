package com.gnjb.fitly.model.user;
...
import com.gnjb.fitly.model.GenericDAO;
...
public class UserDao extends GenericDAO {
	...
	public User findUser(String username) {
		return (User) find(User.class, Restrictions.eq("username", username));
	}

	public User findActiveUser(String username) {
		return (User) find(User.class, Restrictions.eq("username", username), Restrictions.eq("status", Status.ACTIVE));
	}

	public SecurityQuestion findSecurityQuestion(String code) {
		return (SecurityQuestion) find(SecurityQuestion.class, Restrictions.eq("code", code));
	}
